...
# github: https://github.com/Radium-bit/multi-xray
...
BASE_SOURCE_PATH="https://raw.githubusercontent.com/Radium-bit/multi-xray/master"
...
EOF
    ...
    #安装Xray主程序
    [[ ${INSTALL_WAY} == 0 ]] && bash <(curl -L -s https://multi.netlify.app/go.sh) -x
}
